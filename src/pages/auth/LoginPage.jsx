            ...
            <div className="rounded-md shadow-sm">
              ...
              <div className='mt-5 mb-10'>
                ...
                <div className="w-full relative">
                  ...
                  />
                  <button
                    className="absolute top-4 right-5 text-clr-gray hover:underline text-sm"
                    type="button"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  type="checkbox"
                  className="bg-clr-dark-purple border-clr-dark-purple focus:ring-3 focus:ring-clr-dark-purple ring-clr-dark-purple accent-clr-dark-purple h-4 w-4 rounded"
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-gray-900">
                  Remember me
                </label>
              </div>
              <Link to={'/forget-password'} className="text-lg font-semibold text-primary-bright-cyan">Forget Password</Link>
