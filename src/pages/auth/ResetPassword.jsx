...
function ResetPassword() {
  ...
  useEffect(() => {
      ...
      code : formData.code.length > 0 && formData.code.length <=6 ? true : false
		});
	}, [formData]);
  ...
  const handleSubmit = async (e) => {
		...
		if (!formValidate.email || !formValidate.password || !formValidate.code) {
    ...
    <div className="min-h-full h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="flex flex-col items-center">
          ...
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Reset your account</h2>
